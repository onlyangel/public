...
$$.TimerImpl = {"": "Object;_once,_inEventLoop,_handle?",
  ...
  TimerImpl$periodic$2: function(milliseconds, callback) {
    ...
    if ($.hasTimer()) {
      ...
      t1.activeTimerCount = t1.activeTimerCount + 1;
      this._handle = $.get$globalThis().setInterval($.convertDartClosureToJS(new $.anon3(this, callback), 0), milliseconds);
    } else
...
$$.main_anon = {"": "Closure;box_0",
  call$1: function(e) {
    var evm = $.EventsModel$(e);
    this.box_0.evm_0 = evm;
    return evm;
  }
};

$$.EventsModel = {"": "Object;temp,eventsData,daylist<,eventsByDay<,slider<,playstop,repeticion,playing,themap@,circulos,circles<",
  timerStarter$0: function() {
    var t1, t2;
    t1 = this.playing;
    t2 = this.playstop;
    if (t1) {
      ...
      $.set$value$x(t2, "Stop");
      this.repeticion = $.Timer_Timer$periodic($.Duration$(0, 0, 0, 700, 0, 0), this.get$timerClick());
    }
  },
  timerClick$1: function(t) {
    var t1, t2;
    this.playing = true;
    if ($.$lt$n($.int_parse($.get$value$x(this.slider), null, null), this.daylist.length - 1)) {
      t1 = this.slider;
      t2 = $.getInterceptor$x(t1);
      t2.set$value(t1, $.S($.$add$ns($.int_parse(t2.get$value(t1), null, null), 1)));
      this.addMarker$0();
    } else {
      this.playing = false;
      t1 = this.repeticion;
  ...
  get$timerClick: function() {
    return new $.BoundClosure$1(this, "timerClick$1");
  },
  asingEventByDay$1: function($event) {
    var t1, t2;
    t1 = $.getInterceptor$asx($event);
    if ($.$index$asx(t1.$index($event, "location"), "lat") != null) {
      t2 = this.eventsByDay;
      if (t2.$index(t2, t1.$index($event, "start_date")) == null) {
        t2 = this.eventsByDay;
        t2.$indexSet(t2, t1.$index($event, "start_date"), $.List_List($));
      }
      t2 = this.eventsByDay;
      $.add$1$ax(t2.$index(t2, t1.$index($event, "start_date")), $event);
    }
  },
  printlocation$1: function($event) {
    var t1 = $.getInterceptor$asx($event);
    if ($.$index$asx(t1.$index($event, "location"), "lat") != null)
      $.Primitives_printString($.toString$0(t1.$index($event, "location")));
    else
      $.Primitives_printString($.toString$0(t1.$index($event, "city")));
  },
  printEventByDay$0: function() {
    var t1 = {};
    t1.day_0 = "";
    t1.val_1 = null;
    $.forEach$1$ax(this.eventsData, new $.EventsModel_printEventByDay_anon(t1, this));
  },
  showMap$0: function() {
  ...
  EventsModel$1: function(temp) {
    ...
    this.playstop = $.query("#playstop");
    this.eventsData = $.parse(this.temp, null);
    this.eventsByDay = $.Map_Map();
    this.daylist = $.List_List($);
    $.forEach$1$ax(this.eventsData, new $.anon(this));
    this.printEventByDay$0();
    $.set$max$ax(this.slider, "" + (this.daylist.length - 1));
    this.circles = $.List_List($);
    this.showMap$0();
    $.get$onClick$x(this.playstop).listen$1(new $.anon0(this));
  }
};

$$.anon = {"": "Closure;this_0",
  call$1: function(e) {
    this.this_0.asingEventByDay$1(e);
    return;
  }
};
...
$$.anon0 = {"": "Closure;this_1",
  call$1: function(e) {
    return this.this_1.timerStarter$0();
  }
};

$$.EventsModel_printEventByDay_anon = {"": "Closure;box_0,this_1",
  call$1: function($event) {
    var t1, t2, t3;
    t1 = this.box_0;
    t2 = $.getInterceptor$asx($event);
    if ($.$eq(t1.day_0, t2.$index($event, "start_date")) !== true) {
      t1.day_0 = t2.$index($event, "start_date");
      t2 = this.this_1;
      t3 = t2.get$eventsByDay();
      t1.val_1 = t3.$index(t3, t1.day_0);
      if (t1.val_1 != null) {
        t2.get$daylist().push(t1.day_0);
        $.forEach$1$ax(t1.val_1, new $.EventsModel_printEventByDay__anon(t2));
      }
    }
  }
};

$$.EventsModel_printEventByDay__anon = {"": "Closure;this_2",
  call$1: function($event) {
    return this.this_2.printlocation$1($event);
  }
};

$$.EventsModel_showMap_anon = {"": "Closure;this_0",
  call$0: function() {
    var mapOptions, t1, t2;
    mapOptions = $.MapOptions$();
    mapOptions.set$zoom(mapOptions, 2);
    mapOptions.set$center($.LatLng$(30, 0, null));
    mapOptions.set$mapTypeId($.get$MapTypeId_ROADMAP());
    t1 = this.this_0;
    t2 = $.GMap$($.query$1$x(document, "#sample_container_id"), mapOptions);
    $._jsGlobalize.callSync$1($._serialize(t2._jsProxy._proxy.toJs$0()));
    t1.set$themap(t2);
    $.get$onChange$x($.query$1$x(document, "#slider")).listen$1(new $.EventsModel_showMap__anon(t1));
  }
};

$$.EventsModel_showMap__anon = {"": "Closure;this_1",
  call$1: function(e) {
    this.this_1.addMarker$0();
  }
};
...
$$.EventsModel_addMarker_anon = {"": "Closure;this_0",
  call$0: function() {
    ...
    if (day !== (day | 0))
      throw $.iae(day);
    if (day < 0 || day >= t3.length)
      throw $.ioore(day);
    days = t2.$index(t2, t3[day]);
    $.forEach$1$ax(t1.get$circles(), new $.EventsModel_addMarker__anon());
    $.clear$0$ax(t1.get$circles());
    $.forEach$1$ax(days, new $.EventsModel_addMarker__anon0(t1));
    day0 = day - 1;
    if (day0 >= 0) {
      t2 = t1.get$eventsByDay();
      t3 = t1.get$daylist();
      if (day0 < 0 || day0 >= t3.length)
        throw $.ioore(day0);
      $.forEach$1$ax(t2.$index(t2, t3[day0]), new $.EventsModel_addMarker__anon1(t1));
      day = day0;
    }
    if (day - 1 >= 0) {
      --day;
      ...
      if (day < 0 || day >= t3.length)
        throw $.ioore(day);
      $.forEach$1$ax(t2.$index(t2, t3[day]), new $.EventsModel_addMarker__anon2(t1));
    }
    if (day - 1 >= 0) {
      --day;
      t2 = t1.get$eventsByDay();
      ...
      if (day < 0 || day >= t3.length)
        throw $.ioore(day);
      $.forEach$1$ax(t2.$index(t2, t3[day]), new $.EventsModel_addMarker__anon3(t1));
    }
    if (day - 1 >= 0) {
      --day;
      t2 = t1.get$eventsByDay();
      ...
      if (day < 0 || day >= t3.length)
        throw $.ioore(day);
      $.forEach$1$ax(t2.$index(t2, t3[day]), new $.EventsModel_addMarker__anon4(t1));
    }
  }
};

$$.EventsModel_addMarker__anon = {"": "Closure;",
  call$1: function(e) {
    $.set$map$ax(e, null);
    return;
  }
...
$$.EventsModel_addMarker__anon0 = {"": "Closure;this_1",
  call$1: function(cir) {
    ...
    center = $.LatLng$($.$index$asx(t1.$index(cir, "location"), "lat"), $.$index$asx(t1.$index(cir, "location"), "lng"), null);
    opt = $.CircleOptions$();
    opt.set$center(center);
    opt.set$strokeColor("#FF0000");
    opt.set$strokeOpacity(0.8);
    opt.set$strokeWeight(2);
    ...
    $.add$1$ax(t1.get$circles(), circle);
  }
};
...
$$.anon2 = {"": "Closure;",
  call$1: function(jsProxy) {
    return $.GMap$fromJsProxy(jsProxy);
  }
};
...
$$.Circle = {"": "MVCObject;_jsProxy",
  get$map: function(_) {
    return $.get$value$x($.map$1$ax(this.get$$$().getMap$0(), $.get$GMap_INSTANCIATOR()));
  },
  map$1: function($receiver, arg0) {
    return this.get$map($receiver).call$1(arg0);
  },
  set$map: function(_, map) {
    return this.get$$$().setMap$1(map);
  }
};

$$.CircleOptions = {"": "IsJsProxy;_jsProxy",
  set$center: function(center) {
    this.get$$$().set$center(center);
    return center;
  },
  set$fillColor: function(fillColor) {
    this.get$$$().set$fillColor(fillColor);
    return fillColor;
  },
  set$fillOpacity: function(fillOpacity) {
    this.get$$$().set$fillOpacity(fillOpacity);
    return fillOpacity;
  },
  set$map: function(_, map) {
    var t1 = this.get$$$();
  ...
  set$radius: function(radius) {
    this.get$$$().set$radius(radius);
    return radius;
  },
  set$strokeColor: function(strokeColor) {
    this.get$$$().set$strokeColor(strokeColor);
    return strokeColor;
  },
  set$strokeOpacity: function(strokeOpacity) {
    this.get$$$().set$strokeOpacity(strokeOpacity);
    return strokeOpacity;
  },
  set$strokeWeight: function(strokeWeight) {
    this.get$$$().set$strokeWeight(strokeWeight);
    return strokeWeight;
  }
};
...
$$.FunctionProxy = {"": "Proxy;_liblib2$_port,_liblib2$_id",
  noSuchMethod$1: function(_, invocation) {
    ...
    if (invocation.get$isMethod() === true && $.$eq(invocation.get$memberName(), "call") === true) {
      result = this._liblib2$_port.callSync$1([this._liblib2$_id, "", "apply", $.toList$0$ax($.map$1$ax(invocation.get$positionalArguments(), $._serialize))]);
...
$$._ProxiedObjectTable = {"": "Object;_name,_nextId,_liblib2$_deletedCount,_registry<,_liblib2$_port,_globalIds,_handleStack,_scopeIndices<",
  ...
  _ProxiedObjectTable$0: function() {
    this._liblib2$_port.receive$1(new $.anon1(this));
  }
};
...
$.main = function() {
  var t1 = {};
  t1.evm_0 = null;
  $.HttpRequest_getString("events.json", null, null).then$1(new $.main_anon(t1));
};

$.EventsModel$ = function(temp) {
  var t1 = new $.EventsModel(temp, null, null, null, null, null, null, false, null, null, null);
  t1.EventsModel$1(temp);
  return t1;
};
...
$.MapOptions$ = function() {
  return new $.MapOptions($.JsProxy$_($.map($.makeLiteralMap([]))));
};
...
$.Circle$ = function(opts) {
  var t1, t2;
  t1 = $.get$maps().get$Circle();
  t2 = $.JSArray_methods.map$1([opts], $._serialize0);
  t2 = t2.toList$0(t2);
  return new $.Circle($.JsProxy$_($.Proxy_Proxy$withArgList(t1, t2)));
};

$.CircleOptions$ = function() {
  return new $.CircleOptions($.JsProxy$_($.map($.makeLiteralMap([]))));
};
...
$.Proxy__forward = function(receiver, member, kind, args) {
  ...
  result = receiver._liblib2$_port.callSync$1([receiver._liblib2$_id, member, kind, $.toList$0$ax($.map$1$ax(args, $._serialize))]);
  t1 = $.getInterceptor$asx(result);
...
Isolate.$lazy($, "maps", "maps", "get$maps", function() {
  return $.retain($.context().get$google().get$maps());
});
Isolate.$lazy($, "NONE", "NONE", "get$NONE", function() {
  return $.None$_();
});
Isolate.$lazy($, "INSTANCIATOR", "GMap_INSTANCIATOR", "get$GMap_INSTANCIATOR", function() {
  return new $.anon2();
});
...
(function() {
  ...
  $.dynamicSetMetadata([["AbstractWorker", v8_AbstractWorker], ["Uint8Array", v0_Uint8Array], ["ArrayBufferView", [v0_Uint8Array, "ArrayBufferView|DataView|Float32Array|Float64Array|Int16Array|Int32Array|Int8Array|Uint16Array|Uint32Array"].join("|")], ["Blob", "Blob|File"], ["CharacterData", v4_CharacterData], ["Document", v5_Document], ["DocumentFragment", v6_DocumentFragment], ["DOMTokenList", "DOMSettableTokenList|DOMTokenList"], ["HTMLMediaElement", v1_MediaElement], ["SVGElement", v2_SvgElement], ["Element", v3_Element], ["Entry", "DirectoryEntry|Entry|FileEntry"], ["EntrySync", "DirectoryEntrySync|EntrySync|FileEntrySync"], ["Node", v7_Node], ["WorkerContext", v9_WorkerContext], ["MediaStream", v10_MediaStream], ["IDBRequest", v11_Request], ["EventTarget", [v7_Node, v8_AbstractWorker, v9_WorkerContext, v10_MediaStream, v11_Request, "AudioContext|BatteryManager|DOMApplicationCache|DOMWindow|EventSource|EventTarget|FileReader|FileWriter|IDBDatabase|IDBTransaction|MediaController|MediaSource|MediaStreamTrack|MessagePort|Notification|OfflineAudioContext|Performance|RTCDTMFSender|RTCDataChannel|RTCPeerConnection|SVGElementInstance|SourceBufferList|SpeechRecognition|TextTrack|TextTrackCue|TextTrackList|WebKitNamedFlow|WebSocket|XMLHttpRequest|XMLHttpRequestUpload"].join("|")], ["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["NodeList", "NodeList|RadioNodeList"], ["UIEvent", "CompositionEvent|FocusEvent|KeyboardEvent|MouseEvent|SVGZoomEvent|TextEvent|TouchEvent|UIEvent|WheelEvent"], ["CSSValueList", "CSSValueList|WebKitCSSFilterValue|WebKitCSSMixFunctionValue|WebKitCSSTransformValue"]]);
})();
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,eval$1,get$sb,then$1,toJs$0,get$Map,get$_id,get$Date,get$_set,get$_tag,get$maps,lookup$1,toJson$0,get$cause,process$0,_writeOn$1,callSync$1,get$Circle,get$LatLng,get$_state,get$google,get$slider,get$themap,moveNext$0,register$2,set$_state,set$center,set$radius,set$themap,_callback$2,_dispatch$1,_sendData$1,addMarker$0,exitScope$0,get$ROADMAP,get$circles,get$current,get$daylist,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,firstMatch$1,get$isWorker,get$sendPort,toSendPort$0,unregister$1,_setGlobals$0,get$MapTypeId,get$_callback,get$_duration,get$_registry,get$_workerId,set$fillColor,set$mapTypeId,get$_hashTable,get$_isolateId,get$stackTrace,runIteration$0,throwDelayed$0,timerStarter$0,_checkReplyTo$1,get$_futurePort,get$eventsByDay,printlocation$1,set$fillOpacity,set$strokeColor,get$_receivePort,get$topEventLoop,set$strokeWeight,asingEventByDay$1,get$_nextListener,get$_scopeIndices,get$nextIsolateId,set$_nextListener,set$nextIsolateId,set$strokeOpacity,get$currentContext,get$inMilliseconds,_liblib3$_callback$1,get$_hasUnhandledError,get$_resultOrListeners,get$millisecondsSinceEpoch".split(","), longNames = "call,call,call,call,call,eval,sb,then,toJs,Map,_id,Date,_set,_tag,maps,lookup,toJson,cause,process,_writeOn,callSync,Circle,LatLng,_state,google,slider,themap,moveNext,register,_state=,center=,radius=,themap=,_callback,_dispatch,_sendData,addMarker,exitScope,ROADMAP,circles,current,daylist,_handle=,_sendError,_sendValue,catchError,enterScope,firstMatch,isWorker,sendPort,toSendPort,unregister,_setGlobals,MapTypeId,_callback,_duration,_registry,_workerId,fillColor=,mapTypeId=,_hashTable,_isolateId,stackTrace,runIteration,throwDelayed,timerStarter,_checkReplyTo,_futurePort,eventsByDay,printlocation,fillOpacity=,strokeColor=,_receivePort,topEventLoop,strokeWeight=,asingEventByDay,_nextListener,_scopeIndices,nextIsolateId,_nextListener=,nextIsolateId=,strokeOpacity=,currentContext,inMilliseconds,_callback,_hasUnhandledError,_resultOrListeners,millisecondsSinceEpoch".split(",");
...
//@ sourceMappingURL=io13contest.dart.js.map
